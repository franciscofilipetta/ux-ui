...
Desarrollar una solución web que facilite la recaudación de fondos, priorizando la usabilidad, la accesibilidad y una experiencia de usuario fluida. La web no solo busca cumplir una función transaccional, sino también generar confianza y compromiso en el donante a través de un diseño sólido.

**Integrantes**
- Filipetta Francisco 
- Holtz Santiago
- Chiappero Santiago
- Aguirregomezcorta Martin
